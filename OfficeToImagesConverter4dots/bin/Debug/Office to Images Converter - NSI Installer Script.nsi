...
;copy translations end
  ...
  !define MUI_FILE "OfficeToImagesConverter"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Convert Office to Images 4dots"
  !define PRODUCT_SHORTCUT "Convert Office to Images 4dots"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Convert Office to Images 4dots"
  OutFile "OfficeToImagesConverterSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Convert Office to Images 4dots" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Convert Office to Images 4dots - User's Manual.url.lnk" "$INSTDIR\Convert Office to Images 4dots - User's Manual.url" "" "$INSTDIR\Convert Office to Images 4dots - User's Manual.url" 0
...
;  ExecWait "$PLUGINSDIR\Installmanager.exe 015" 
 ...
 ; File "readme.txt"
  ;File "..\..\..\helpfile\Convert Office to Images 4dots - User's Manual.chm";
  File "Convert Office to Images 4dots - User's Manual.url";
  File "ddb.dat"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Convert Office to Images 4dots" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Convert Office to Images 4dots" "InstallationDirectory" $INSTDIR
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Convert Office to Images 4dots"
  DeleteRegKey HKCU "Software\4dots Software\Convert Office to Images 4dots"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/office-to-images-converter/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/office-to-images-converter/how-to-use.php?afterinstall=true"
FunctionEnd
