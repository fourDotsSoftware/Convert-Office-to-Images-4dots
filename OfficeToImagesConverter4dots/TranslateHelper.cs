    ...
    class TranslateHelper
    {
        ...
        public static string Translate(string str)
        {
            if (rm == null)
            {
                ...
                rm = new System.Resources.ResourceManager("OfficeToImagesConverter4dots.ResRegister", cm.GetType().Assembly);
            ...
            {
                TranslateHelper cm = new TranslateHelper();
                rm2 = new System.Resources.ResourceManager("OfficeToImagesConverter4dots.ResTranslate", cm.GetType().Assembly);
            }
